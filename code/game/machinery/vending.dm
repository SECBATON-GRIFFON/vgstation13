...
/obj/machinery/vending/chemomat
	...
	products = list(
		...
		/obj/item/weapon/reagent_containers/glass/bottle/lithium = 10,
		/obj/item/weapon/reagent_containers/glass/bottle/tungsten = 10,
		/obj/item/weapon/reagent_containers/glass/bottle/ethanol = 10
		)
	contraband = list(
		/obj/item/weapon/reagent_containers/food/drinks/coffee = 10,
		/obj/item/weapon/reagent_containers/glass/bottle/fuel = 10,
		/obj/item/weapon/reagent_containers/glass/bottle/piccolyn = 10,
		/obj/item/weapon/reagent_containers/glass/bottle/mercury = 5,
