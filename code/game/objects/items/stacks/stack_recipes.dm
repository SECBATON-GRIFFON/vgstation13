...
var/list/datum/stack_recipe/metal_recipes = list (
	...
	new/datum/stack_recipe("drywall",   /obj/structure/window/barricade/drywall,                1, time = 25, on_floor = 1),
...
var/list/datum/stack_recipe/wood_recipes = list (
	...
	new/datum/stack_recipe("drywall",   /obj/structure/window/barricade/drywall/wood,   1, 		time = 25, on_floor = 1),
