var/list/flora_types = list(
									...
									/obj/machinery/atmospherics/unary/wc/sink/puddle = 3,
							 )
...
var/list/cave_decor_types = list(
									...
									/obj/machinery/atmospherics/unary/wc/sink/puddle = 12,
							 )
...
/proc/break_room(var/area/target)
	...
	for(var/obj/machinery/atmospherics/unary/wc/sink/S in target)
		if(!istype(S, /obj/machinery/atmospherics/unary/wc/sink/puddle))
			new /obj/machinery/atmospherics/unary/wc/sink/puddle(S.loc)
			qdel(S)
