...
#define iscleanaway(A) (istype(A,/obj/effect/decal/cleanable) || (istype(A,/obj/effect/overlay) && !istype(A, /obj/effect/overlay/hologram)) || istype(A,/obj/effect/rune_legacy) || A.ErasableRune() || istype(A,/obj/effect/ash))

#define isadvcleanaway(A) (istype(A,/obj/effect/decal/cleanable) || istype(A,/obj/effect/liquid) || (istype(A,/obj/effect/overlay) && !istype(A, /obj/effect/overlay/hologram)) || istype(A,/obj/effect/rune_legacy) || A.ErasableRune())
