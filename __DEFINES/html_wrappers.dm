...
#define VG_BROWSE_REF_DIM(user, window_id, title, width, height, ref, content) \
new /datum/browser/clean/est(user, window_id, title, width, height, ref, content)

#define VG_BROWSE_DIM(user, window_id, title, width, height, content) \
new /datum/browser/clean/est(user, window_id, title, width, height, ncontent = content)

#define VG_BROWSE(user, window_id, title, content) \
new /datum/browser/clean/est(user, window_id, title, ncontent = content)

#define VG_BROWSE_REF(user, window_id, title, ref, content) \
